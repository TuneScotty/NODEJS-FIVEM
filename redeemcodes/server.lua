...
function sendToDiscord(tit,msg,colr)
	PerformHttpRequest("https://discord.com/api/webhooks/803874992567091240/6a0WkAwlD5dd9f2Zm5OZKra8DBKirmcfZqhCwO__3NN-hZpwz8VJ4wAPrr-3dVxsqaGK", function(a,b,c)end, "POST", json.encode({embeds={{title=tit,description=msg:gsub("%^%d",""),color=colr,}}}), {["Content-Type"]="application/json"})
  end